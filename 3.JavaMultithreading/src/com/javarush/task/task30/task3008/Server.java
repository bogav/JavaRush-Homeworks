...
public class Server {
    ...
    public static void sendBroadcastMessage(Message message){
        try {
            ...
            ConsoleHelper.writeMessage("The message wasnt sent!");
        }
    }
    ...
    private static class Handler extends Thread{
        ...
        public void run() {
            if (socket != null && socket.getRemoteSocketAddress() != null) {
                ConsoleHelper.writeMessage("New connection to a remote socket address established: " + socket.getRemoteSocketAddress());
            }
